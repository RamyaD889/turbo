...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5399707372:AAEnmy53i5gu9HPJHor_QS1gdcAsQcwtoqk")
...
AUTH_CHANNEL = [int(x) for x in os.environ.get("AUTH_CHANNEL", "885394844").split()]
