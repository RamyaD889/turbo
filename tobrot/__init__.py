...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "leech3")
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "extract3")
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "archive3")
GLEECH_COMMAND = os.environ.get("GLEECH_COMMAND", "mirror3")
GLEECH_UNZIP_COMMAND = os.environ.get("GLEECH_UNZIP_COMMAND", "mirror_extract3")
GLEECH_ZIP_COMMAND = os.environ.get("GLEECH_ZIP_COMMAND", "mirror_archive3")
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "watch3")
GYTDL_COMMAND = os.environ.get("GYTDL_COMMAND", "mirrorwatch3")
RCLONE_CONFIG = os.environ.get("RCLONE_CONFIG", "")
DESTINATION_FOLDER = os.environ.get("DESTINATION_FOLDER", "Tamilan")
INDEX_LINK = os.environ.get("INDEX_LINK", "https://tamilanda.mirrorboy.workers.dev")
TELEGRAM_LEECH_COMMAND = os.environ.get("TELEGRAM_LEECH_COMMAND", "filemirror3")
TELEGRAM_LEECH_UNZIP_COMMAND = os.environ.get("TELEGRAM_LEECH_UNZIP_COMMAND", "filemirrorunzip3")
CANCEL_COMMAND_G = os.environ.get("CANCEL_COMMAND_G", "cancel")
GET_SIZE_G = os.environ.get("GET_SIZE_G", "getsize")
STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "status")
SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "savethumb3")
CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clrthumb3")
UPLOAD_AS_DOC = os.environ.get("UPLOAD_AS_DOC", "False")
PYTDL_COMMAND = os.environ.get("PYTDL_COMMAND", "playlistdl3")
GPYTDL_COMMAND = os.environ.get("GPYTDL_COMMAND", "mirrorplaylist3")
LOG_COMMAND = os.environ.get("LOG_COMMAND", "log")
CLONE_COMMAND_G = os.environ.get("CLONE_COMMAND_G", "gclone")
UPLOAD_COMMAND = os.environ.get("UPLOAD_COMMAND", "upload")
RENEWME_COMMAND = os.environ.get("RENEWME_COMMAND", "reset3")
RENAME_COMMAND = os.environ.get("RENAME_COMMAND", "rename3")
